...
$packageName = 'araxismerge' # arbitrary name for the package, used in messages
$installerType = 'MSI' #only one of these: exe, msi, msu
$url = 'http://www.araxis.com/download/Merge2013.4377-win32.msi' # download url
$url64 = 'http://www.araxis.com/download/Merge2013.4377-x64.msi' # 64bit URL here or remove - if installer decides, then use $url
